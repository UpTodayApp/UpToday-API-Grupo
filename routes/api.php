...
Route::get('/grupo', [grupoController::class, 'ListarTodas']);
Route::get('/grupo/{d}', [grupoController::class, 'ListarUna']);
Route::post('/grupo', [grupoController::class, 'Crear']);
Route::delete('/grupo/{d}', [grupoController::class, 'Eliminar']);
Route::put('/grupo/{d}', [grupoController::class, 'Modificar']);
